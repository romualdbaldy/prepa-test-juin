...
--
-- Base de données :  `prepa_test_juin`
--
CREATE DATABASE IF NOT EXISTS `prepa_test_juin` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `prepa_test_juin`;
...
(1, 'Administrateur', 'Tous les droits', 0),
(2, 'Modérateur', 'desactive un utilisateur', 1),
(3, 'Utilisateur', 'utilisateur', 2);
...
(1, 'Admin', 'admin', 'romneo69@hotmail.com', 'Baldy Romuald', 1, '2015-06-12 09:33:02', '21232f297a57a5a743894a0e4a801fc3', 1);
